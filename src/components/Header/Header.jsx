...
const Header = () => {
  ...
  <Modal setVisible={setVisible} visible={visible}>
    <p><a style={{display:'flex', justifyContent: 'center'}} href='https://github.com/ILYA9090' target="_blank">ссылка на мой gitHub</a></p>
    <p>интересы: стритлифтинг, фитнеc, история, трейдинг, коллекционирование, автомбоили ну и конечно же любимый фронт энд</p>

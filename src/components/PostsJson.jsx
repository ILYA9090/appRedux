import { useGetPostsQuery, useAddPostsMutation, useRemovePostsMutation } from '../slices/apiApp';
    ...
    <div className="apiQuery">
      ...
      <Modal visible={modal} setVisible={setModal} handleResetForm={resetForm}>
        <form onSubmit={handleAddPosts}>
          <input type="text" placeholder="введите имя" value={title} onChange={handleChangeInput} />
